...
class Character:
    ...
    def attack(self, target):
        ...
        print(f"\n{self.name} attacks {damage} damage.")
    ...
    def take_damage(self, damage):
        ...
        if self.health < 0:
            self.health = 0
        print(f"\n{self.name} takes {damage} damage (health now {self.health})")
...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        target.take_damage(damage)
        print(f"{self.name} performs a mighty warrior strike ⚔️ for {damage}")
...
class Mage(Player):
    ...
    def attack(self, target):
        ...
        damage = self.magic
        target.take_damage(damage)
        print(f"{self.name} casts a magic blast 🪄 for {damage} damage!")
...
if __name__ == "__main__":
    ...
    warrior = Warrior("Son Goku")
    mage = Mage("Aladdin")
    rogue = Rogue("Nightwing")
